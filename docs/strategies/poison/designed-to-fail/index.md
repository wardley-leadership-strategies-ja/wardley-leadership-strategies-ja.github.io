...
- アナリストや投資家が、実現性の弱い 過熱感 を追っている。
- 初期採用者 や標準に、まだ影響できる余地がある。
momentum_moves:
...
これは戦術的 妨害工作 です。立ち上がりつつある空間へ、最初から失敗するよう仕込んだ施策を投入し、認識を歪め、競合資源を消耗させ、市場形成の本気度を下げます。
...
こうした施策は 注目 を占有し、勢いを分散し、他者の投資意欲を下げます。
...
汚い戦い方をしながら、信頼や士気を壊さないことです。冷徹な分析と 冷徹な な優先順位付けが必要で、引き金を引けない人や 副作用 を制御できない人は避けるべき戦術です。
...
この戦略は、狡知と欺きの境界上にあります。多用すると、内外に 冷笑主義 を生みます。発覚時は 信頼崩壊 を招きます。

## 📋 **進め方**

1. 脆い新興市場セグメントを特定する
2. 表面上は 信頼できる だが、内部に欠陥を持つ施策を設計する
3. 広報や提携で正当な取り組みに見せかけて投入する
4. 自己修復されないよう、統治と貢献経路を握る
5. 競合反応と市場反応を監視する
6. 競合が 抑止 を受けたら、施策を崩壊させる
...
競合やコミュニティが欠陥を修正し、 実行可能な な提供物に変えてしまうことがあります。
...
欠陥施策でも、もっともらしい物語と 派手な演出 がなければ効きません。正当な取り組みに見えなければ、欠陥がすぐ露見します。

### Osborne Effect の増幅

将来の 優れた な何かが来るように匂わせるだけで、競合の現行製品への需要を凍らせられることがあります。

### エコシステム汚染

欠陥標準や欠陥プラットフォームへ、開発者、統合事業者、投資家を引き込み、その失敗で空間全体を 不毛 に見せることができます。
...
この施策は長生きしてはいけません。役目は一時的な占有と歪み作りです。 偶発的 に成立してしまう前に、計画的に終える必要があります。

### あくまで 周辺の一手

これは普通、中心戦略ではなく周辺の 戦術的な一手 です。価値創造より毒の注入に依存しすぎると、組織文化まで腐ります。

## ❓ **問うべきこと**

- どの隣接市場が本当の戦略リスクか
- 表面 信頼性 を保ちつつ、欠陥を埋め込めるか
- どう 廃止 して 巻き添え被害 を抑えるか
- 便益は評判・法務リスクに見合うか
...
- [過去の成功は慣性を生む](/climatic-patterns/past-success-breeds-inertia) – 関係: 老朽化した中核 を守るために使われることがある

## 📚 **参考文献**

- [HD DVD 対 Blu-ray (Wikipedia)](https://en.wikipedia.org/wiki/HD_DVD) — 市場分断と失敗の例
- [Betamax 対 VHS (Wikipedia)](https://en.wikipedia.org/wiki/Betamax) — プロプライエタリな 規格戦争の例
