...
- kdmsnr
title: 失敗するよう設計する
description: 競合が利益を得る前に、市場自体を汚す欠陥施策を意図的に投入する戦略。
stages:
- 創世記
- カスタムビルド
goals:
...
- アナリストや投資家が、実現性の弱い過熱感を追っている。
- 初期採用者や標準に、まだ影響できる余地がある。
momentum_moves:
...
これは戦術的妨害工作です。立ち上がりつつある空間へ、最初から失敗するよう仕込んだ施策を投入し、認識を歪め、競合資源を消耗させ、市場形成への意欲をくじきます。
...
こうした施策は注目を占有し、勢いを分散し、他者の投資意欲を下げます。
...
汚い戦い方をしながら、信頼や士気を壊さないことです。冷徹な分析と優先順位付けが必要であり、実行後の副作用を制御できないなら避けるべき戦術です。
...
この戦略は、狡知と欺きの境界上にあります。多用すると、内外に冷笑主義を生みます。発覚時は信頼崩壊を招きます。

## 📋 **進め方**

1. 脆い新興市場セグメントを特定する
2. 表面上は信頼できるが、内部に欠陥を持つ施策を設計する
3. 広報や提携で正当な取り組みに見せかけて投入する
4. 自己修復されないよう、統治と貢献経路を握る
5. 競合反応と市場反応を監視する
6. 競合が抑止を受けたら、施策を崩壊させる
...
競合やコミュニティが欠陥を修正し、実行可能な提供物に変えてしまうことがあります。
...
欠陥施策でも、もっともらしい物語と派手な演出がなければ効きません。正当な取り組みに見えなければ、欠陥がすぐ露見します。

### オズボーン効果の増幅

将来もっと優れたものが登場すると匂わせるだけで、競合の現行製品への需要を凍らせられることがあります。

### エコシステム汚染

欠陥標準や欠陥プラットフォームへ、開発者、統合事業者、投資家を引き込み、その失敗で空間全体を不毛に見せることができます。
...
この施策は長生きしてはいけません。役目は一時的な占有と歪み作りです。偶発的に成立してしまう前に、計画的に終える必要があります。

### あくまで周辺の一手

これは普通、中心戦略ではなく周辺の戦術的な一手です。価値創造より毒の注入に依存しすぎると、組織文化まで腐ります。

## ❓ **問うべきこと**

- どの隣接市場が本当の戦略リスクか
- 表面上の信頼性を保ちつつ、欠陥を埋め込めるか
- どう廃止して巻き添え被害を抑えるか
- 便益は評判・法務リスクに見合うか
...
- [過去の成功は慣性を生む](/climatic-patterns/past-success-breeds-inertia) – 関係: 老朽化した中核を守るために使われることがある
