...
シリコンバレーは、世界の技術人材にとって重心になりました。Google、Apple、Facebook などが作った引力により、優秀な人材が自然に集まりました。たとえば Google は AI 研究の論文公開、TensorFlow の公開、会議開催などで AI 人材の中心地になり、分野の方向へ強い影響を持ちました。

### オープンソース・エコシステムにおける Red Hat

Red Hat は、オープンソースのプロジェクトに投資し、それを支える事業と文化を構築することで、企業向けオープンソースの重心になりました。Linux をめぐる人材や顧客が Red Hat に集まり、IBM のような大企業でさえその引力を無視できませんでした。
