...
実験とは、新しいアイデア、技術、市場を探索するために、軽量な試行を意図的に使うことです。組織はハックデー、ラボ、スカンクワークスのような場を作り、通常の制約の外で動けるようにします。実験は可逆で安価であるべきで、大きな資源を賭ける前に、地図上の一手を試せます。
...
### Lockheed MartinのSkunk Works

小規模で隔離されたチームが、通常の官僚手続きを迂回しつつSR-71 Blackbirdのようなブレークスルーを実現しました。

### FacebookのHackathon

短時間のハッカソンからLikeボタンのような機能が生まれ、ユーザー関与を先行維持する助けになりました。

### 仮想例: 創薬の加速

AIを使う小さな探索チームが化合物スクリーニングを高速化し、従来R&Dより早く有望候補へ到達するケースです。
...
<Assessment strategyName="実験">
 ...
 <Readiness>
  ...
  <li>ハックデーやラボに使える時間やチームを確保できる。</li>
...
派手なハッカソンだけで、実製品へ影響しないなら信用を失います。
...
- [重心](/strategies/attacking/centre-of-gravity) - 強いラボは人材を引き寄せる中心になる
...
- [ファストフォロワー](/strategies/positional/fast-follower) - 他社の成功実験を素早く取り込む
...
- [エンパワード](/books/empowered)
- [エンパワード・プロダクトチーム](https://www.svpg.com/empowered-product-teams/)
- [Googleの20%ルール](https://www.wired.com/2013/08/20-percent-time-will-never-die/)
- [スカンクワークス](https://www.lockheedmartin.com/en-us/who-we-are/business-areas/aeronautics/skunkworks.html)
