...
戦略的先送りとは、新しい市場や進化中の市場で、先行者にならないことを意図的に選ぶ戦略です。大きく不確実な初期投資はせず、競合に初期コスト、初期失敗、市場教育を任せます。自社はファストフォロワーとして、市場が見えてから入ります。
...
待つのは得意でも、素早く動く筋力を失っている企業があります。ファストフォロワーになれないと失敗します。
...
大企業では、中核市場では先行者、隣接市場ではファストフォロワーという組み合わせもありえます。イノベーション投資全体のリスクを分散できます。
