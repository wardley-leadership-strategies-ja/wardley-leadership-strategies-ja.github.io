...
GPS、気象、公共交通データなどを公開した政府や組織は、その上で新しい産業が生まれる土台を作りました。たとえば ロンドン交通局（TfL）はリアルタイム交通データを API で公開し、経路検索、アクセシビリティ支援、モビリティアプリを多数生みました。データ自体を開くことで、周辺市場全体を大きくした例です。
