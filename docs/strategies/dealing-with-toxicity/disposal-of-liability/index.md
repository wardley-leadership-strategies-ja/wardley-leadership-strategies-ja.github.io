...
ここでいう 戦略的切り離し は、スピンオフ、スプリットオフ、カーブアウト、事業売却、段階的閉鎖などを含む広い概念です。負債の処分 は、その中でも特に、重荷、時代遅れ、不整合、あるいは有害になった製品、サービス、運用を価値連鎖から取り除く行為を指します。
...
<Assessment strategyName="Strategic Divestment and 負債の処分">
 <MapSignals>
...
3. 売却、スピンオフ、カーブアウト、停止などの具体策を設計する
...
- HBR の ポートフォリオ整理 系記事は、切り離し判断とタイミングの参考になる
