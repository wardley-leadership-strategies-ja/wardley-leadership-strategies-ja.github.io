...
ファーストフォロワーは、先行者の成功と失敗を観察し、市場が十分に見えた段階で、より洗練された提供物を素早く投入する戦略です。未知を切り拓くのではなく、見え始めた道を速く正確に走ります。
...
<Assessment strategyName="ファーストフォロワー">
  <MapSignals>
...
Wardley の枠組みでは、ファーストフォロワーは Settler 的な役割を担います。未知の開拓ではなく、見えてきた価値を安定した運用へ落とし込む役目です。
