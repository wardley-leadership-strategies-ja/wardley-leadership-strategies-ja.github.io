...
EV の普及前に充電インフラを敷いたことで、Tesla は車両販売だけでなく利用体験の土台そのものを押さえました。後発はネットワークを一から作るか、劣位の体験を甘受する必要がありました。

### Google AdWords

検索意図と広告在庫を結ぶ仕組みを早期に握ったことで、Google は広告市場の入口を支配しました。市場拡大後は、既に線路を持つ立場でルールを決められました。
