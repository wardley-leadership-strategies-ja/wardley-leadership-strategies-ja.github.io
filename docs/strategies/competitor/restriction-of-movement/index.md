...
- 規制や契約の隙間を使って、排他的条件を先に押さえられそうだ。
momentum_moves:
- ボトルネックになる流通、データ、能力への排他的アクセスを確保する。
- 主要パートナーを相互誘因でより強く結びつける契約を結ぶ。
- 法務、技術、エコシステムの障壁を積み重ね、代替案を魅力薄にする。
watch_outs:
- 排他性を強く出しすぎて、独禁法やパートナー反発を招くこと。
- 相手を塞ぐことに集中し、自分の進化を止めること。
- 相手に課した制約で、自分まで動けなくなること。
