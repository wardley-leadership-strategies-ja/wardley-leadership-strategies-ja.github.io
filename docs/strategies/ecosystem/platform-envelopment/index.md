...
- ユーザーが摩擦なく 束ねられたサービス へ移れる 移行経路 を用意する。
watch_outs:
- 吸収される開発者や販売者を遠ざけること。
- 自社優遇 と見なされ、規制対応が必要になること。
...
- [リスク管理とレジリエンス](/leadership-skills/risk-management-and-resilience) — 反トラスト と 反発 を抑える
- [プラットフォーム戦略とネットワーク効果](/leadership-skills/platform-strategy-and-network-effects) — 新サービスを プラットフォームに組み込む
- [戦略的コミュニケーションとストーリーテリング](/leadership-skills/strategic-communication-and-storytelling) — 社内外へ 理由 を説明する
...
2. 戦略適合とリスクを評価する。TAM、ロックイン、競争上の位置取り、反トラスト を見る
3. 手段を決める。統合、束ね、吸収 のどれで行くか選ぶ
4. 必要 能力 を内製または買収で確保する
