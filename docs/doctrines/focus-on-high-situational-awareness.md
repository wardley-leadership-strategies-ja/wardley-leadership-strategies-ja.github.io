...
Wardleyは、状況認識がなければ他のあらゆる指針が単なる見せかけに堕すると強調します。`状況認識を重視する` とは、ユーザーニーズ、バリューチェーン、各コンポーネントの進化を示す生きた地図に戦略を根ざすことです。何が実際に検討されているのかを理解してはじめて、リーダーは適切な手法を選び、前提を疑い、状況が変わる前に対応できます。
