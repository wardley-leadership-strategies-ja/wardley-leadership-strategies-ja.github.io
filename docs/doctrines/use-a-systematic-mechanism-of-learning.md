...
Wardleyは、フィードバックループがなければ指針は無意味だと強調します。`体系的な学習の仕組みを使う` とは、あらゆる意思決定を通じて地図が改善されるよう、環境を計測可能にすることをリーダーへ求めるものです。支出管理、サービス標準、成果のテレメトリは、バリューチェーンを洗練し、前提がもはや成り立たなくなった瞬間を捉えるためのデータを与えます。
